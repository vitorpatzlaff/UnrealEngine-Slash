...
public:
	...
	// Equips the weapon to a Character
...
protected:
	...
	// UFUNCTION(BlueprintImplementableEvent) needed if the logic will be implemented on the blueprints and in the protected section
